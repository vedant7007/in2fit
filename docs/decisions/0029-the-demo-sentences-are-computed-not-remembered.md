...
1. **Every Hindi row went to the model.** The markers of `0033` were Latin script: the hi
...
2. **A quantity or a household unit beside a food, with no question marker, is a meal stated.**
   ...
   spoon, ml, gram, and their Hindi forms) as positive evidence. The asymmetry of `0033` holds:
