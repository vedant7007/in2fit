...
| # | check | why |
| --- | --- | --- |
| 1 | **Airplane mode on.** Wi-Fi and Bluetooth off too (airplane mode leaves them as they were). | Beat 0 is the proof; it must already be true before the phone is held up. |
...
| 6 | **Do Not Disturb on.** No calls, no banners. | A notification over the transcript is the kind of thing judges remember. |
